...
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка, ДополнительныеПараметры)
	...
	Для каждого ПолеРасшифровки Из ПоляРасшифровки Цикл
		Если СтрНайти(ПолеРасшифровки.Ключ,"Корова") ИЛИ СтрНайти(ПолеРасшифровки.Ключ,"Тёлка") ИЛИ СтрНайти(ПолеРасшифровки.Ключ,"Брак") ИЛИ СтрНайти(ПолеРасшифровки.Ключ,"ФактОтёл") Тогда
