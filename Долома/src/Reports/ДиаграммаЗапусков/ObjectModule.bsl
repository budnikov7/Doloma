...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
    ...
    ПараметрВариантДиаграммы = НастройкиОтчета.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("ВариантДиаграммы"));
    ВариантДиаграммы = ПараметрВариантДиаграммы.Значение; 
	КоличествоДней = 300;
	Если ВариантДиаграммы = "Дней после отёла" Тогда
		КоличествоДней = 900;	
	КонецЕсли;
