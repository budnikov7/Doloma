...
Процедура ДобавитьКолонки(ВыборкаГрупп)
	...
	Пока ВыборкаГрупп.Следующий() Цикл  
		...
		Если Элементы.Найти(НаименованиеГруппы) = Неопределено Тогда
			...
			НижняяГраницаОтклонения = НаименованиеГруппы + "_НижняяГраницаОтклонения";
			ВерхняяГраницаОтклонения = НаименованиеГруппы + "_ВерхняяГраницаОтклонения";

			ИмяПоказывать 	= НаименованиеГруппы + "_ПоказыватьВРационе";
			МассивДобавляемыхРеквизитов.Добавить(Новый РеквизитФормы(ИмяМинимум, 
				Новый ОписаниеТипов("Число",,,Новый КвалификаторыЧисла(10,2)),"ТаблицаНормативов","Мин."));
			МассивДобавляемыхРеквизитов.Добавить(Новый РеквизитФормы(ИмяМаксимум, 
				Новый ОписаниеТипов("Число",,,Новый КвалификаторыЧисла(10,2)),"ТаблицаНормативов","Макс."));
			МассивДобавляемыхРеквизитов.Добавить(Новый РеквизитФормы(НижняяГраницаОтклонения, 
				Новый ОписаниеТипов("Число",,,Новый КвалификаторыЧисла(10,2)),"ТаблицаНормативов","Нижнее отклонение"));
			МассивДобавляемыхРеквизитов.Добавить(Новый РеквизитФормы(ВерхняяГраницаОтклонения, 
				Новый ОписаниеТипов("Число",,,Новый КвалификаторыЧисла(10,2)),"ТаблицаНормативов","Верхнее отклонение")); 
			МассивДобавляемыхРеквизитов.Добавить(Новый РеквизитФормы(ИмяПоказывать, 
				Новый ОписаниеТипов("Булево"),"ТаблицаНормативов","Показывать")); 
			...
			ДобавитьКолонку(НижняяГраницаОтклонения, "Нижнее отклонение", "ТаблицаНормативов." + ИмяМинимум, Группа);
			ДобавитьКолонку(ВерхняяГраницаОтклонения, "Верхнее отклонение", "ТаблицаНормативов." + ИмяМаксимум, Группа);
...
Процедура ЗаполнитьПоказателиИзРегистра(ВыборкаНормативов)
	...
	Пока ВыборкаНормативов.Следующий() Цикл
		...
		Для каждого НайденнаяСтрока Из НайденныеСтроки Цикл
			...
			НайденнаяСтрока[ИмяКолонкиГруппы + "_НижняяГраницаОтклонения"] = ВыборкаНормативов.НижняяГраницаОтклонения;
			НайденнаяСтрока[ИмяКолонкиГруппы + "_ВерхняяГраницаОтклонения"] = ВыборкаНормативов.ВерхняяГраницаОтклонения;
...
Процедура ЗаписатьНаСервере()
	...
	Для каждого СтрокаПоказателя Из ТаблицаНормативов Цикл  
		...
		Для каждого ГруппаЖивотных Из СписокГруппЖивотных Цикл 
			...
			НижняяГраницаОтклонения = ГруппаЖивотных.Представление + "_НижняяГраницаОтклонения";
			ВерхняяГраницаОтклонения = ГруппаЖивотных.Представление + "_ВерхняяГраницаОтклонения";
			...
			Если ЗаписьНабора.Минимум <> СтрокаПоказателя[ИмяМинимум] ИЛИ ЗаписьНабора.Максимум <> СтрокаПоказателя[ИмяМаксимум] 
				...
				ЗаписьНабора.НижняяГраницаОтклонения = СтрокаПоказателя[НижняяГраницаОтклонения];
				ЗаписьНабора.ВерхняяГраницаОтклонения = СтрокаПоказателя[ВерхняяГраницаОтклонения];
